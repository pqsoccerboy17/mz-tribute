    ...
    <div className="fixed top-[56px] left-0 right-0 z-40 bg-navy-lighter/95 backdrop-blur-md border-b border-bvb-yellow/10">
      <div className="mx-auto max-w-6xl px-4 py-2 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            onClick={logout}
            className="flex items-center gap-1.5 text-xs text-text-muted hover:text-red-400 px-3 py-1.5 rounded-lg bg-white/5 border border-white/10 hover:border-red-400/30 transition-all cursor-pointer"
          >
